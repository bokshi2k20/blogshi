                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                <span class="color-green"><a href="garden-category.html" title="">{{$singleposts->category->title}}</a></span>
                                ...
                                <div class="post-sharing">
                                    <ul class="list-inline">
                                        <li><a href="{{route('share')}}" class="fb-button btn btn-primary"><i class="fa fa-facebook"></i> <span class="down-mobile">Share on Facebook</span></a></li>
                                    </ul>
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <h4><a href="#">{{$singleposts->user->name}}</a></h4>
